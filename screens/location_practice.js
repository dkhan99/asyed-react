...
import { StyleSheet, Text, Location, View, Linking, Dimensions, TouchableHighlight, DeviceEventEmitter, NativeModules } from 'react-native'
        ...
        <View style={{alignItems:'flex-start'}}>
          ...
          <View style={styles.row}>
            ...
            <View style={[styles.detailBox,{width:deviceWidth/2}]}>
              ...
              <Text style={[styles.detail,{fontSize:15}]}>
                {(this.state.location.timestamp).format("MM-DD-YYYY h:mm:ss")}
              </Text>
            </View>
          </View>
